...
export class HomePage {
	...
	nnnowCatSlidesPerView: number = 3.2;
	slidesPerView = {
		nnnowCategory: 3.2,
		basicProductGrid: 2.5
	} 
	...
	constructor(public navCtrl: NavController, private WC: WooCommerceProvider, public loader: LoadingProvider,
		...
		if (this.platform.width() >= 800) {
			this.slidesPerView.nnnowCategory = 5.2;
			this.slidesPerView.basicProductGrid = 3.5;
		}
		else if (this.platform.width() >= 600) {
			this.slidesPerView.nnnowCategory = 4.2;
			this.slidesPerView.basicProductGrid = 2.8;
		} else if (this.platform.width() >= 412) {
			this.slidesPerView.nnnowCategory = 4.2;
			this.slidesPerView.basicProductGrid = 2.5;
		}
		else if (this.platform.width() >= 319) {
			this.slidesPerView.nnnowCategory = 3.2;
			this.slidesPerView.basicProductGrid = 2.3;
		}
